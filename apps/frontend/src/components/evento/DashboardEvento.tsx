		...
		<div className="flex flex-col gap-2">
			...
			<div className="grid grid-cols-3 gap-6 mt-4">
				<Estatistica
					...
					valor={props.evento.publicoEsperado.toString()}
					imagem="/icones/convidados.svg"
				/>
				<Estatistica
					texto="Confirmações:"
					valor={props.presentes.length.toString()}
					imagem="/icones/confirmados.svg"
				/>
				<Estatistica
					texto="Total confirmado:"
					valor={props.totalGeral.toString()}
					imagem="/icones/acompanhantes.svg"
				/>
			</div>

			<button type="button" className="botao azul self-end mt-12">
